...
const studioProjects: readonly StudioProject[] = [
  ...
  {
    name: "Modular bag studio",
    href: "/app/bag-studio",
    label: "Open drafting table",
    details: "Shared bag geometry, live vectors, fabric plans + closure kits",
    meta: "Sewing studio / Modular pattern drafting",
